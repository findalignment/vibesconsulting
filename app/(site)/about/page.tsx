  ...
  return (
    <div className="pb-20">
      <header className="mb-12">
        ...
        <p className="mt-3 text-xl text-white/90 max-w-3xl">We fix the flow.</p>
      </header>
        ...
        <div className="card p-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-white/70">Continuous improvement, customer focus, process optimization. We use proven quality management frameworks to diagnose and fix operational friction.</p>
            </div>
            <div>
              <h4 className="text-lg font-semibold text-white mb-2">Human-Centered Systems Thinking</h4>
              <p className="text-white/70">Structure, rituals, communication loops. We design systems that work with how people actually operate, not against them.</p>
            </div>
            <div>
              <h4 className="text-lg font-semibold text-white mb-2">AI Enablement</h4>
              <p className="text-white/70">Practical, safe adoption of automation tools to reduce noise and error. We help teams use AI responsibly and effectively.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="card p-6">
            ...
            <p className="text-white/70">Simple, actionable insights. No jargon, no consultant theater.</p>
          </div>
          <div className="card p-6">
            <h3 className="text-lg mb-2">Flow over force</h3>
            <p className="text-white/70">Systems should enable momentum, not require constant pushing.</p>
          </div>
          <div className="card p-6">
            <h3 className="text-lg mb-2">People over theatrics</h3>
            <p className="text-white/70">Real humans doing real work. We design for how teams actually operate.</p>
          </div>
          <div className="card p-6">
            <h3 className="text-lg mb-2">Continuous improvement over quick wins</h3>
            <p className="text-white/70">Sustainable change beats temporary fixes. We build systems that last.</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="card p-8">
          <p className="text-white/90 mb-6">Based in <strong>Santa Cruz, CA</strong>, we work with boutique businesses and owner-operators who care about their people and the vibe.</p>
      ...
      <section className="mb-16">
        ...
        <div className="card p-8">
          <p className="text-white/80 leading-relaxed mb-4">Founded by Rock Hudson in Santa Cruz, Vibes Consulting brings together decades of experience in total quality management, organizational design, and modern technology adoption.</p>
          <p className="text-white/80 leading-relaxed">Rock has helped owner-operators across industries transform chaotic operations into smooth, sustainable systems that people love working within.</p>
        </div>
      </section>
