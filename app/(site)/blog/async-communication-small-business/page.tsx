    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Async Communication for Santa Cruz Small Businesses</h1>
          <p className="text-xl md:text-2xl text-brand-text/70 leading-relaxed">Not everything needs a meeting. Here's how local businesses are moving to async communication and getting hours back.</p>
        </header>
...
<div className="bg-current-600/10 p-6 rounded-lg mt-12">
          ...
          <div className="mt-24 pt-16 border-t border-white/10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link href="/blog/client-work-versus-business-building" className="card p-6 hover:border-current-500/50 transition-colors group">
                <p className="text-sm text-current-500 mb-2">Operations</p>
                <h4 className="text-xl font-semibold text-brand-text mb-3 group-hover:text-current-500 transition-colors">Client Work Versus Business Building</h4>
              ...
              <Link href="/blog/information-scattered-everywhere" className="card p-6 hover:border-current-500/50 transition-colors group">
                <p className="text-sm text-current-500 mb-2">Operations</p>
                <h4 className="text-xl font-semibold text-brand-text mb-3 group-hover:text-current-500 transition-colors">Information Scattered Everywhere</h4>
