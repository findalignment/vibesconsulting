    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Automation Without Losing the Personal Touch</h1>
          <p className="text-xl md:text-2xl text-white/70 leading-relaxed">Santa Cruz businesses thrive on personal relationships. Here's how to automate admin work while staying human.</p>
        </header>
        ...
        <div className="space-y-8">
          ...
          <div className="mt-20 pt-12 border-t border-white/10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link href="/blog/small-business-sustainability-paradox" className="card p-6 hover:border-current-500/50 transition-colors group">
                <p className="text-sm text-current-500 mb-2">AI & Automation</p>
                <h4 className="text-xl font-semibold text-white mb-3 group-hover:text-current-500 transition-colors">Small Business Sustainability Paradox</h4>
              ...
              <Link href="/blog/data-privacy-ai-local-business" className="card p-6 hover:border-current-500/50 transition-colors group">
                <p className="text-sm text-current-500 mb-2">AI & Automation</p>
                <h4 className="text-xl font-semibold text-white mb-3 group-hover:text-current-500 transition-colors">Data Privacy Ai Local Business</h4>
