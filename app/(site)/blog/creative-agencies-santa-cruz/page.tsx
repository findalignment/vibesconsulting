    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Operations for Santa Cruz Creative Agencies: Creativity Needs Structure</h1>
          <p className="text-xl md:text-2xl text-brand-text/70 leading-relaxed">Creative agencies think structure kills creativity. But chaos kills delivery. Here\'s how Santa Cruz agencies are building systems that support great work.</p>
        </header>
