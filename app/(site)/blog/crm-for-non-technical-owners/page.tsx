    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <p className="text-xl md:text-2xl text-white/70 leading-relaxed">You know you need a CRM. But which one? And how do you actually use it? A practical guide for local businesses.</p>
        </header>
