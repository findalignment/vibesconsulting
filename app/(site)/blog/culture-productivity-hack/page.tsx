  ...
  const sections = [
    {
      ...
      content: (
        <>
          ...
          <p>These are the invisible rules that shape how work feels. And when they're unhealthy, no amount of process optimization will fix the underlying problem.</p>
        </>
      )
    },
    {
      title: "Why Productivity Hacks Backfire",
      content: (
        <>
          <p>The productivity industrial complex wants you to believe that the right app, the right framework, or the right morning routine will solve everything.</p>
    ...
    {
      title: "The Five Culture Levers That Actually Matter",
      content: (
        <>
    ...
    {
      title: "The Symptoms of Broken Culture",
      content: (
        <>
    ...
    {
      title: "Why Culture Work Feels Fuzzy (And Why It's Not)",
      content: (
        <>
    ...
    },
    {
      ...
      content: (
        <>
          <p>You don't need to overhaul everything at once. Start with one ritual that's broken. Maybe it's your weekly team meeting that everyone dreads. Maybe it's the lack of clear ownership. Maybe it's the expectation of 24/7 availability.</p>
          <p>Pick the one thing causing the most friction and redesign it. Not with a new tool. With a new agreement about how you operate.</p>
          <p>Then give it 4 weeks. Measure the impact. (Are people less stressed? Are decisions happening faster? Is quality improving?)</p>
          <p>If it works, lock it in and move to the next friction point.</p>
        </>
      )
    },
    {
      title: "The ROI of Good Culture",
      content: (
        <>
          <p>Good culture isn't a nice-to-have. It's a competitive advantage. When people aren't burned out, they do better work, stay longer, refer great people, and solve problems proactively.</p>
          <p>When your business has good flow, you're not constantly replacing people, retraining, or firefighting. You're building momentum. That's the real productivity hack.</p>
          <p>Learn more about our <Link href="/services/culture-optimization" className="text-current-500 hover:underline">Culture Optimization service</Link>.</p>
        </>
      )
    }
  ]
