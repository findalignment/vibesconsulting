    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">The Customer Experience and Operations Disconnect</h1>
          <p className="text-xl md:text-2xl text-white/70 leading-relaxed">After evaluating thousands of businesses, the pattern is clear: poor customer experience is always an operations problem.</p>
        </header>
          ...
          <div className="mt-24 pt-16 border-t border-white/10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link href="/blog/revenue-up-profits-flat" className="card p-6 hover:border-current-500/50 transition-colors group">
                ...
                <h4 className="text-xl font-semibold text-white mb-3 group-hover:text-current-500 transition-colors">Revenue Up Profits Flat</h4>
              ...
              <Link href="/blog/urgent-always-beats-important" className="card p-6 hover:border-current-500/50 transition-colors group">
                <p className="text-sm text-current-500 mb-2">Operations</p>
                <h4 className="text-xl font-semibold text-white mb-3 group-hover:text-current-500 transition-colors">Urgent Always Beats Important</h4>
