    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <p className="text-xl md:text-2xl text-brand-text/70 leading-relaxed">AI tools are powerful but can expose your data. Here\'s how to adopt AI safely without putting your Santa Cruz business or clients at risk.</p>
        </header>
          ...
          <div className="mt-24 pt-16 border-t border-white/10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link href="/blog/team-waiting-for-answers" className="card p-6 hover:border-current-500/50 transition-colors group">
                ...
                <h4 className="text-xl font-semibold text-brand-text mb-3 group-hover:text-current-500 transition-colors">Team Waiting For Answers</h4>
                <p className="text-brand-text/70 text-sm">Practical insights on improving your business operations.</p>
              </Link>
              <Link href="/blog/sustainable-growth-versus-growth-at-all-costs" className="card p-6 hover:border-current-500/50 transition-colors group">
                <p className="text-sm text-current-500 mb-2">AI & Automation</p>
                <h4 className="text-xl font-semibold text-brand-text mb-3 group-hover:text-current-500 transition-colors">Sustainable Growth Versus Growth At All Costs</h4>
