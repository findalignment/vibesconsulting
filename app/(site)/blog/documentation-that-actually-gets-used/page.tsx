    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">How to Create Business Documentation That Your Team Actually Uses</h1>
          <p className="text-xl md:text-2xl text-brand-text/70 leading-relaxed">Most SOPs sit in a folder untouched. Here's how to document processes in a way that actually helps your Santa Cruz team.</p>
        </header>
