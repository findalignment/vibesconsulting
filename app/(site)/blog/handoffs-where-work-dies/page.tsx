    ...
    <div className="pb-20 max-w-3xl">
      ...
      <article>
        <header className="mb-8">
          <time className="text-white/60 text-sm">November 15, 2024</time>
          <h1 className="mt-2 mb-4">Handoffs: Where Work Goes to Die</h1>
          <p className="text-xl text-white/80">Projects stall between people. Handoffs are where momentum disappears.</p>
        </header>
