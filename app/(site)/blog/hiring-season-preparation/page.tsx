    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <p className="text-xl md:text-2xl text-white/70 leading-relaxed">Q4 is coming. If your onboarding isn't smooth, new hires will struggle. Here's how to prepare now.</p>
        </header>
