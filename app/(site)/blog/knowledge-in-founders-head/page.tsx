    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">When All the Knowledge Lives in Your Head</h1>
          <p className="text-xl md:text-2xl text-brand-text/70 leading-relaxed">You're the only one who knows how things work. This makes you essential and exhausted.</p>
        </header>
