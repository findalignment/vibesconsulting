    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-8">
          <h1 className="mb-4">The Path of Least Resistance</h1>
          <p className="text-brand-text/60">November 22, 2025 · 8 min read</p>
        </header>
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-brand-text/70 leading-relaxed">
          ...
          <p>
            Not because of a single catastrophic event. Not because someone designed them. But because of something far more powerful: <strong className="text-brand-text">the relentless movement of a natural force following the path of least resistance.</strong>
          </p>
          ...
          <h2 className="text-2xl font-semibold text-brand-text mt-10 mb-4">How Natural Forces Shape Systems</h2>
          ...
          <p>
            <strong className="text-brand-text">Behavior flows like gravity toward the path of least resistance.</strong>
          </p>
          ...
          <h2 className="text-2xl font-semibold text-brand-text mt-10 mb-4">The Life-Giving Force</h2>
          ...
          <p>
            Rivers carve valleys that become fertile plains. They distribute nutrients. They create ecosystems. Entire civilizations formed along riverbanks not because rivers were convenient, but because <strong className="text-brand-text">consistent, predictable flow enables growth.</strong>
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 text-brand-text/70">
            <li>Information moves to where it's needed without someone manually routing it</li>
            <li>Decisions happen at the right level without escalating unnecessarily</li>
            <li>Processes are documented, so new people can ramp up quickly</li>
            <li>Feedback loops are short, so problems surface before they compound</li>
            <li>People know what they own, so they don't wait for permission</li>
          </ul>
          ...
          <div className="card p-6 bg-white/5 my-6">
            ...
            <p className="text-brand-text/70 text-sm mt-3">
          ...
          <h2 className="text-2xl font-semibold text-brand-text mt-10 mb-4">The Destructive Force</h2>
          ...
          <p>
            Floods erode soil. They undermine foundations. They carve paths that destabilize entire landscapes. Not because the force is inherently malicious, but because <strong className="text-brand-text">when flow has no channel, it goes everywhere - and erodes everything.</strong>
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 text-brand-text/70">
            <li>Information spreads through gossip instead of official channels</li>
            <li>Decisions get made in side conversations, leaving others out of the loop</li>
            <li>Work bypasses the documented process because "it's faster this way"</li>
            <li>Firefighting becomes normal because problems aren't caught early</li>
            <li>People do whatever feels easiest in the moment, creating chaos downstream</li>
          </ul>
          ...
          <p>
            And here's the danger: <strong className="text-brand-text">these informal paths work in the short term.</strong> They relieve immediate friction. But over time, they erode the structure you built. They create silos. They make knowledge transfer impossible. They turn your organization into a maze only veterans can navigate.
          </p>
          ...
          <h2 className="text-2xl font-semibold text-brand-text mt-10 mb-4">Why Slow, Repeated Movement Wins</h2>
          ...
          <p>
            But <strong className="text-brand-text">small, consistent changes, repeated over time, reshape everything.</strong>
          </p>
          ...
          <h3 className="text-xl font-semibold text-brand-text mt-8 mb-3">Weekly Rituals Over Annual Offsites</h3>
          ...
          <h3 className="text-xl font-semibold text-brand-text mt-8 mb-3">Incremental Documentation Over Big Knowledge Bases</h3>
          ...
          <h3 className="text-xl font-semibold text-brand-text mt-8 mb-3">Continuous Small Improvements Over Radical Overhauls</h3>
          ...
          <h2 className="text-2xl font-semibold text-brand-text mt-10 mb-4">Designing Channels, Not Fighting Gravity</h2>
          ...
          <p>
            A better approach: <strong className="text-brand-text">Design channels that align with the path of least resistance.</strong>
          </p>
          ...
          <p>
            If information spreads through hallway conversations instead of official updates, maybe your update format is too formal. Can you make it a 3-bullet async Slack post instead of a meeting?
          </p>

          <p>
            <strong className="text-brand-text">You don't fight gravity. You build aqueducts.</strong>
          </p>
          ...
          <h2 className="text-2xl font-semibold text-brand-text mt-10 mb-4">The Two Questions</h2>

          <p>
            When you look at your organization, ask yourself:
          </p>

          <h3 className="text-xl font-semibold text-brand-text mt-8 mb-3">1. Where is the current going?</h3>
          ...
          <p>
            <em className="text-brand-text/90">Where is it actually going?</em>
          </p>

          <ul className="list-disc pl-6 space-y-2 text-brand-text/70">
            <li>Where do decisions really get made? (In meetings? In Slack DMs? In parking lot conversations?)</li>
            <li>Where does information really live? (In people's heads? In Notion? In scattered Google Docs?)</li>
            <li>What workarounds has your team created because the official way is too slow?</li>
          </ul>
          ...
          <h3 className="text-xl font-semibold text-brand-text mt-8 mb-3">2. Are you channeling it, or is it eroding you?</h3>
          ...
          <p>
            The fix isn't to dam the flow. It's to <strong className="text-brand-text">design better channels.</strong>
          </p>

          <h2 className="text-2xl font-semibold text-brand-text mt-10 mb-4">What This Means For You</h2>
          ...
          <h2 className="text-2xl font-semibold text-brand-text mt-10 mb-4">Start With One Channel</h2>
          ...
          <ul className="list-disc pl-6 space-y-2 text-brand-text/70">
            <li>Decision-making that happens in back channels instead of documented forums</li>
            <li>Information trapped in people's heads instead of shared systems</li>
            <li>Work bypassing your process because it's faster to just "wing it"</li>
          </ul>
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <div className="card p-8 bg-current-600/10">
            <h3 className="text-xl mb-3">Ready to Build Better Channels?</h3>
            <p className="text-brand-text/70 mb-6">We'll map where the current actually flows in your business, identify where it's eroding vs. nourishing, and design intentional channels that work with human nature instead of against it.</p>
            <Link href="/contact" className="btn btn-primary">Schedule a Flow Check</Link>
          </div>
          ...
          <div className="mt-24 pt-16 border-t border-white/10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link href="/blog/good-people-bad-systems" className="card p-6 hover:border-current-500/50 transition-colors group">
                ...
                <h4 className="text-xl font-semibold text-brand-text mb-3 group-hover:text-current-500 transition-colors">Good People Bad Systems</h4>
                <p className="text-brand-text/70 text-sm">Practical insights on improving your business operations.</p>
              </Link>
              <Link href="/blog/calendar-owns-you" className="card p-6 hover:border-current-500/50 transition-colors group">
                <p className="text-sm text-current-500 mb-2">Operations</p>
                <h4 className="text-xl font-semibold text-brand-text mb-3 group-hover:text-current-500 transition-colors">Calendar Owns You</h4>
