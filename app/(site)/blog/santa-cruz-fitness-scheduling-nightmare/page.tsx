    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">The Santa Cruz Fitness Studio Scheduling Nightmare</h1>
          <p className="text-xl md:text-2xl text-brand-text/70 leading-relaxed">Local fitness businesses lose revenue to bad scheduling systems. This is fixable with better operations.</p>
        </header>
...
<div className="bg-current-600/10 p-6 rounded-lg mt-12">
          ...
          <div className="mt-24 pt-16 border-t border-white/10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Link href="/blog/retail-operations-santa-cruz" className="card p-6 hover:border-current-500/50 transition-colors group">
                <p className="text-sm text-current-500 mb-2">Santa Cruz Business</p>
                <h4 className="text-xl font-semibold text-brand-text mb-3 group-hover:text-current-500 transition-colors">Retail Operations Santa Cruz</h4>
