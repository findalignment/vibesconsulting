      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          <div className="flex items-center gap-3 text-sm text-brand-text/60 mb-4">
            <time>July 26, 2025</time>
            <span>•</span>
            <span>6 min read</span>
            <span>•</span>
            <span className="text-current-500">Santa Cruz Business</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Systems for Santa Cruz Wellness Businesses That Don't Kill the Vibe</h1>
          <p className="text-xl md:text-2xl text-brand-text/70 leading-relaxed">Yoga studios, training spaces, and wellness centers need structure that supports, not stifles. Here's how to build it.</p>
        </header>
