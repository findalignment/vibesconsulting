    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <p className="text-xl md:text-2xl text-white/70 leading-relaxed">Santa Cruz wellness businesses are maturing. The ones that systematize will thrive. The ones that stay informal will struggle.</p>
        </header>
          ...
          <div className="mt-20 pt-12 border-t border-white/10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link href="/blog/sustainable-business-operations-santa-cruz" className="card p-6 hover:border-current-500/50 transition-colors group">
                ...
                <h4 className="text-xl font-semibold text-white mb-3 group-hover:text-current-500 transition-colors">Sustainable Business Operations Santa Cruz</h4>
              ...
              <Link href="/blog/santa-cruz-fitness-facilities-operations" className="card p-6 hover:border-current-500/50 transition-colors group">
                <p className="text-sm text-current-500 mb-2">Santa Cruz Business</p>
                <h4 className="text-xl font-semibold text-white mb-3 group-hover:text-current-500 transition-colors">Santa Cruz Fitness Facilities Operations</h4>
