    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <p className="text-xl md:text-2xl text-brand-text/70 leading-relaxed">You started solo. Now you have 5-10 people. Everything that used to work is breaking. Here\'s how to scale without losing what makes you special.</p>
        </header>
