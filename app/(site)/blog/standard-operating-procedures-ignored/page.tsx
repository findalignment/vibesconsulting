    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">You Have SOPs. Nobody Follows Them.</h1>
          <p className="text-xl md:text-2xl text-brand-text/70 leading-relaxed">You documented everything. But your team still asks questions. Documentation alone doesn't fix process.</p>
        </header>
...
<div className="mt-24 pt-16 border-t border-white/10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link href="/blog/documentation-that-actually-gets-used" className="card p-6 hover:border-current-500/50 transition-colors group">
                <p className="text-sm text-current-500 mb-2">Operations</p>
                <h4 className="text-xl font-semibold text-brand-text mb-3 group-hover:text-current-500 transition-colors">Documentation That Actually Gets Used</h4>
