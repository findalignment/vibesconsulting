      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          <div className="flex items-center gap-3 text-sm text-brand-text/60 mb-4">
            <time>September 29, 2024</time>
            <span>•</span>
            <span>6 min read</span>
            <span>•</span>
            <span className="text-current-500">Operations</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">You Make Strategic Plans. They Never Get Executed.</h1>
          <p className="text-xl md:text-2xl text-brand-text/70 leading-relaxed">Quarterly planning feels productive. Then nothing changes. Execution requires systems, not just plans.</p>
        </header>
