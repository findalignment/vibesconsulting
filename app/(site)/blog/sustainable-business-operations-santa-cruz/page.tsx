    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Sustainable Business Operations in Santa Cruz: More Than Just Green Marketing</h1>
          <p className="text-xl md:text-2xl text-brand-text/70 leading-relaxed">Santa Cruz businesses care about sustainability. But sustainable operations mean efficiency, not just eco-friendly products.</p>
        </header>
