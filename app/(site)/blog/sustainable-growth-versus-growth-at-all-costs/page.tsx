    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <p className="text-xl md:text-2xl text-brand-text/70 leading-relaxed">Santa Cruz businesses want to grow responsibly. But growth without systems creates chaos. Here's the sustainable path.</p>
        </header>
