    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <p className="text-xl md:text-2xl text-white/70 leading-relaxed">You want your Santa Cruz team to make decisions independently. But you're worried about mistakes. Here's how to do both.</p>
        </header>
          ...
          <div className="mt-24 pt-16 border-t border-white/10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link href="/blog/quality-inconsistent-across-team" className="card p-6 hover:border-current-500/50 transition-colors group">
                ...
                <h4 className="text-xl font-semibold text-white mb-3 group-hover:text-current-500 transition-colors">Quality Inconsistent Across Team</h4>
