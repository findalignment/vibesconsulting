    ...
    <div className="pb-20">
      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 pb-8 border-b border-white/10">
          ...
          <p className="text-xl md:text-2xl text-brand-text/70 leading-relaxed">Sustainability starts with eliminating operational waste. Most businesses waste 30% of their effort on unnecessary tasks.</p>
        </header>
