    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ul className="list-disc pl-6 space-y-2 text-brand-text/70 my-4">
            <li><strong className="text-brand-text">Small businesses (5-20 people)</strong> that have outgrown informal systems</li>
            <li><strong className="text-brand-text">Service-based businesses</strong> (consulting, creative, wellness, fitness, professional services)</li>
            <li><strong className="text-brand-text">Founders who are the bottleneck</strong> and want to build a business that runs without them</li>
            <li><strong className="text-brand-text">Teams that care about culture</strong> and want sustainable growth, not chaos</li>
          </ul>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p><strong className="text-brand-text">1. We implement, not just advise.</strong> Most consultants give you a deck and leave. We stay until it's working.</p>
          <p><strong className="text-brand-text">2. We design for how you actually work.</strong> No corporate frameworks that don't fit small businesses. Everything is tailored to your size and style.</p>
          <p><strong className="text-brand-text">3. We focus on flow, not just efficiency.</strong> We care about whether people can do their best work, not just whether they're "productive."</p>
        </>
      )
    },
    {
  ...
  const pricingQuestions = [
    {
      ...
      content: (
        <>
          ...
          <ul className="list-disc pl-6 space-y-2 text-brand-text/70 my-4">
            <li><strong className="text-brand-text">Flow Check:</strong> $1,500 - 3-week operational audit</li>
            <li><strong className="text-brand-text">Flow Rebuild:</strong> $8,500 - 8-week implementation project</li>
            <li><strong className="text-brand-text">Vibe Partnership:</strong> $12,000 - 12-week full transformation</li>
            <li><strong className="text-brand-text">Add-ons:</strong> $750-$2,500 (AI Prompt Library, Meeting OS, etc.)</li>
          </ul>
  ...
  const processQuestions = [
    {
      ...
      content: (
        <>
          ...
          <ul className="list-disc pl-6 space-y-2 text-brand-text/70 my-4">
            <li><strong className="text-brand-text">Flow Check:</strong> 3 weeks (audit only, no implementation)</li>
            <li><strong className="text-brand-text">Flow Rebuild:</strong> 8 weeks (design + implementation)</li>
            <li><strong className="text-brand-text">Vibe Partnership:</strong> 12 weeks (full transformation)</li>
            <li><strong className="text-brand-text">Ongoing services:</strong> 3-6 month engagements</li>
          </ul>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ol className="list-decimal pl-6 space-y-2 text-brand-text/70 my-4">
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ul className="list-disc pl-6 space-y-2 text-brand-text/70 my-4">
            <li><strong className="text-brand-text">Discovery:</strong> 30-60 min interviews with key people</li>
            <li><strong className="text-brand-text">Feedback rounds:</strong> Review our recommendations (async)</li>
            <li><strong className="text-brand-text">Implementation:</strong> Training sessions (1-2 hours total)</li>
            <li><strong className="text-brand-text">Check-ins:</strong> Weekly 15-30 min syncs</li>
          </ul>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ul className="list-disc pl-6 space-y-2 text-brand-text/70 my-4">
            <li><strong className="text-brand-text">Ongoing support:</strong> Monthly retainer for coaching and optimization</li>
            <li><strong className="text-brand-text">Implementation help:</strong> We stay until it sticks</li>
            <li><strong className="text-brand-text">Quarterly check-ins:</strong> Make sure things are still working</li>
          </ul>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p><strong className="text-brand-text">1. The consultant gave you a plan but didn't help implement it.</strong> Plans are useless if they sit in a drawer. We stay until it's working.</p>
          <p><strong className="text-brand-text">2. The solution didn't fit your culture or size.</strong> Cookie-cutter frameworks from big-company consulting don't work for 10-person teams. We design for you.</p>
          <p><strong className="text-brand-text">3. There was no follow-through.</strong> Change requires coaching, feedback loops, and accountability. We build that in.</p>
    ...
    <div className="pb-20">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12">
          <section>
            <h2 className="text-2xl font-bold text-brand-text mb-6">General Questions</h2>
            <BlogAccordion sections={generalQuestions} />
          </section>

          <section>
            <h2 className="text-2xl font-bold text-brand-text mb-6">Pricing & Investment</h2>
            <BlogAccordion sections={pricingQuestions} />
          </section>

          <section>
            <h2 className="text-2xl font-bold text-brand-text mb-6">Process & Timeline</h2>
            <BlogAccordion sections={processQuestions} />
          </section>

          <section>
            <h2 className="text-2xl font-bold text-brand-text mb-6">Services & Capabilities</h2>
        ...
        <section className="mt-20 card p-8 md:p-12 bg-gradient-to-br from-current-600/20 to-current-800/30 border-current-500/30 text-center">
          <h2 className="text-2xl font-bold text-brand-text mb-4">Still Have Questions?</h2>
