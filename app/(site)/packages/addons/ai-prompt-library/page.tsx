    ...
    <div className="pb-20">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-16">
        ...
        <div className="card p-6">
          ...
          <p className="text-white/70 text-sm">Custom prompts</p>
        </div>
        <div className="card p-6">
      ...
      <section className="mb-16">
        ...
        <div className="space-y-4">
          ...
          <div className="card p-6">
            ...
            <p className="text-white/70 text-sm mb-3">Notion page, Google Doc, or your preferred format. Searchable, categorized by use case, with clear instructions for each prompt.</p>
          </div>

          <div className="card p-6">
            <h3 className="text-lg mb-2">Usage Guidelines</h3>
            <p className="text-white/70 text-sm mb-3">When to use each prompt, how to customize variables, what to review before using output. Makes adoption foolproof.</p>
          </div>

          <div className="card p-6">
            <h3 className="text-lg mb-2">Training Session (1 hour)</h3>
            <p className="text-white/70 text-sm mb-3">Live walkthrough with your team. Everyone practices using the prompts with real work. Questions answered in real-time.</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="card p-4">
            <h4 className="text-white text-sm font-medium mb-2">Client Communication</h4>
          ...
          <div className="card p-4">
            <h4 className="text-white text-sm font-medium mb-2">Content Creation</h4>
            <ul className="text-white/60 text-xs space-y-1">
          ...
          <div className="card p-4">
            <h4 className="text-white text-sm font-medium mb-2">Meeting & Documentation</h4>
            <ul className="text-white/60 text-xs space-y-1">
          ...
          <div className="card p-4">
            <h4 className="text-white text-sm font-medium mb-2">Data & Analysis</h4>
            <ul className="text-white/60 text-xs space-y-1">
      ...
      <section className="mb-16">
        ...
        <div className="space-y-4">
          <div className="card p-6">
            ...
            <p className="text-white/70 text-sm">We interview 3-5 team members (15 min each) to understand your most time-consuming repetitive tasks. We capture your brand voice, tone preferences, and specific use cases.</p>
          </div>

          <div className="card p-6">
            <h3 className="text-sm font-medium text-current-500 mb-2">Day 3-5: Build & Test</h3>
            <p className="text-white/70 text-sm">We create prompts, test them with sample data, refine based on output quality, and organize them into your library document.</p>
          </div>

          <div className="card p-6">
            <h3 className="text-sm font-medium text-current-500 mb-2">Day 6-7: Train & Deliver</h3>
            <p className="text-white/70 text-sm">1-hour training session with your team. We deliver the final library and answer questions. You're ready to use AI consistently.</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-16 card p-6">
        ...
        <div className="space-y-4">
          <div>
            <h4 className="text-white font-medium mb-1 text-sm">Can we update the library later?</h4>
            <p className="text-white/70 text-sm">Yes. We deliver it in an editable format. Add your own prompts as you discover new use cases.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-white/70 text-sm">Flow Rebuild includes 5-7 prompts specific to the system we're rebuilding. This add-on gives you 15-20 prompts across your entire business.</p>
          </div>
        </div>
      </section>
      ...
      <section className="card p-8 bg-current-600/10 text-center">
        ...
        <p className="text-white/80 max-w-2xl mx-auto mb-6">Add this to any package or purchase standalone. Book a call to discuss your use cases.</p>
