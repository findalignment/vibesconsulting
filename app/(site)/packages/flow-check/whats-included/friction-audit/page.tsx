      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="card p-4">
              <h3 className="text-white text-sm font-medium mb-2">Process Observation (3-4 hours)</h3>
              <p className="text-white/70 text-xs mb-2">We shadow your team during real work. Client calls, project handoffs, internal meetings. We observe where work flows and where it stalls.</p>
              <p className="text-white/60 text-xs italic">Example: We watch a project kickoff and notice the same questions get asked every time because there's no standard brief template.</p>
            </div>
            <div className="card p-4">
              <h3 className="text-white text-sm font-medium mb-2">Team Interviews (5-7 people, 30 min each)</h3>
              <p className="text-white/70 text-xs mb-2">Confidential conversations with team members at different levels. We ask: What takes longer than it should? What's frustrating? What would you change?</p>
              <p className="text-white/60 text-xs italic">Example: Three people independently mention that getting approval for small decisions is a bottleneck.</p>
            </div>
            <div className="card p-4">
              <h3 className="text-white text-sm font-medium mb-2">Bottleneck Analysis</h3>
              <p className="text-white/70 text-xs mb-2">We map the 3-5 highest-impact friction points. For each one, we document: what's happening, why it's happening, how much time it costs, and who's affected.</p>
              <p className="text-white/60 text-xs italic">Example: "Client onboarding takes 2 weeks because intake forms are incomplete, requiring 3-4 back-and-forth emails per client."</p>
            </div>
            <div className="card p-4">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="card p-4">
              <h4 className="text-white text-sm font-medium mb-2">We Look For:</h4>
            ...
            <div className="card p-4">
              <h4 className="text-white text-sm font-medium mb-2">We Measure:</h4>
              <ul className="text-white/70 text-xs space-y-1">
        ...
        <section>
          ...
          <div className="card p-6 bg-current-600/10">
            <p className="text-white/90 mb-4">After the Friction Audit, you'll know:</p>
        ...
        <section>
          ...
          <p className="text-white/80 mb-4">The Friction Audit is one of four deliverables in the Flow Check package. It gets paired with:</p>
          <div className="space-y-3">
            <Link href="/packages/flow-check/whats-included/flow-map" className="card p-4 hover:border-current-600/60 transition-all block">
              ...
              <p className="text-white/70 text-xs">Shows how your workflows should work once friction is removed</p>
            </Link>
            <Link href="/packages/flow-check/whats-included/improvement-plan" className="card p-4 hover:border-current-600/60 transition-all block">
              ...
              <p className="text-white/70 text-xs">Phased action plan for fixing the friction we found</p>
            </Link>
        ...
        <section className="card p-8 bg-current-600/10 text-center">
          ...
          <p className="text-white/80 mb-6">The Friction Audit is included in every Flow Check. Book an intro call to get started.</p>
