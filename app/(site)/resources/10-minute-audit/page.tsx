    ...
    <div className="pb-20">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div className="space-y-8">
            <div className="card p-8 bg-gradient-to-br from-current-600/20 to-current-800/30 border-current-500/30">
              <h2 className="text-2xl font-bold mb-6 text-white">You'll Identify:</h2>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="text-current-500 text-xl">✓</span>
                  <span className="text-white/80">Your #1 operational bottleneck</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-current-500 text-xl">✓</span>
                  <span className="text-white/80">Which processes are slowing you down</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-current-500 text-xl">✓</span>
                  <span className="text-white/80">Where knowledge gaps exist in your team</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-current-500 text-xl">✓</span>
                  <span className="text-white/80">Communication breakdowns and their root causes</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-current-500 text-xl">✓</span>
                  <span className="text-white/80">Quick wins you can implement today</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-current-500 text-xl">✓</span>
                  <span className="text-white/80">When it's time to get professional help</span>
                </li>
              </ul>
            </div>
            ...
            <div className="card p-6 bg-white/5 border-l-4 border-current-500">
              ...
              <ol className="space-y-3 text-white/70 text-sm">
                <li><strong className="text-white">1.</strong> Download the PDF checklist</li>
                <li><strong className="text-white">2.</strong> Answer 20 yes/no questions (10 minutes)</li>
                <li><strong className="text-white">3.</strong> Score yourself across 5 key areas</li>
                <li><strong className="text-white">4.</strong> Get your customized recommendations</li>
              </ol>
            </div>

            <div className="card p-6 bg-white/5">
              <p className="text-white/70 text-sm">
                <strong className="text-white">This audit covers:</strong> Decision-making, documentation, communication, onboarding, and scalability. Each area gets a clarity score so you know exactly where to focus.
              </p>
            </div>
          </div>
          ...
          <div>
            <div className="card p-8 sticky top-8">
              <h3 className="text-xl font-bold mb-4 text-white">Get Your Free Audit</h3>
              <p className="text-white/70 mb-6">Instant download. No spam, just the checklist.</p>
              ...
              <form className="space-y-4">
                ...
                <div>
                  <label htmlFor="team-size" className="block text-sm text-white/70 mb-2">Team Size (Optional)</label>
                  <select
                    id="team-size"
                    name="team-size"
        ...
        <section className="card p-8 md:p-12 bg-white/5 mb-12">
          <h2 className="text-2xl font-bold mb-8 text-white text-center">The 5 Areas We Assess</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <div className="card p-6 bg-white/5">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Decision-Making</h3>
              <p className="text-white/70 text-sm">Who can decide what? Where do decisions stall? Are you the bottleneck?</p>
            </div>
            ...
            <div className="card p-6 bg-white/5">
              ...
              <p className="text-white/70 text-sm">Is knowledge in people's heads or in systems? Can someone onboard without you?</p>
            </div>
            ...
            <div className="card p-6 bg-white/5">
              ...
              <p className="text-white/70 text-sm">How does info flow? What falls through cracks? Are meetings actually useful?</p>
            </div>
            ...
            <div className="card p-6 bg-white/5">
              ...
              <p className="text-white/70 text-sm">How long until someone's productive? Do they shadow forever or have real training?</p>
            </div>
            ...
            <div className="card p-6 bg-white/5 md:col-span-2 max-w-md mx-auto">
              ...
              <p className="text-white/70 text-sm">Can you grow without chaos? What breaks at 2x revenue? At 3x team size?</p>
            </div>
          </div>
        </section>

        <section className="card p-8 bg-gradient-to-br from-current-600/10 to-current-800/20 border-current-500/20 mb-12">
          <h2 className="text-xl font-bold mb-4 text-white">What Happens After You Complete the Audit?</h2>
          <div className="space-y-4 text-white/70">
            <p>The checklist gives you a score for each area (0-4 points). Based on your total score:</p>
            <ul className="space-y-2 ml-6">
              <li><strong className="text-white">16-20 points:</strong> You're doing great. Minor optimizations only.</li>
              <li><strong className="text-white">11-15 points:</strong> Some friction. Fixable with focused effort.</li>
              <li><strong className="text-white">6-10 points:</strong> Significant gaps. Time to systematize.</li>
              <li><strong className="text-white">0-5 points:</strong> Critical issues. Professional help recommended.</li>
            </ul>
        ...
        <section className="text-center">
          <h2 className="text-2xl font-bold mb-4 text-white">Need Help Implementing Your Findings?</h2>
