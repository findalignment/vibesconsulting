  ...
  return (
    <div className="pb-20 max-w-4xl">
      ...
      <div className="space-y-8 text-brand-text/70">
        <section>
          <p className="text-sm text-brand-text/60 mb-6">Last Updated: January 2025</p>
        ...
        <section>
          <h2 className="text-brand-text text-xl font-semibold mb-4">Service-Based Business</h2>
        ...
        <section>
          <h2 className="text-brand-text text-xl font-semibold mb-4">Satisfaction Guarantee</h2>
        ...
        <section>
          <h2 className="text-brand-text text-xl font-semibold mb-4">Refund Policy by Package</h2>
          
          <div className="space-y-6">
            <div className="card p-6">
              <h3 className="text-brand-text text-lg mb-3">The Flow Check ($2,500)</h3>
            ...
            <div className="card p-6">
              <h3 className="text-brand-text text-lg mb-3">The Flow Rebuild ($8,000)</h3>
              <ul className="space-y-2 text-sm">
            ...
            <div className="card p-6">
              <h3 className="text-brand-text text-lg mb-3">The Vibe Partnership (Monthly Retainer)</h3>
              <ul className="space-y-2 text-sm">
            ...
            <div className="card p-6">
              <h3 className="text-brand-text text-lg mb-3">Add-On Services</h3>
              <ul className="space-y-2 text-sm">
        ...
        <section>
          <h2 className="text-brand-text text-xl font-semibold mb-4">Cancellation Process</h2>
          <p className="mb-2">To cancel or request a refund:</p>
          <ol className="list-decimal pl-6 space-y-2">
            <li>Email us at <a href="mailto:info@vibes.consulting" className="text-current-500 hover:underline">info@vibes.consulting</a> with "Cancellation Request" in the subject line</li>
        ...
        <section>
          <h2 className="text-brand-text text-xl font-semibold mb-4">Non-Refundable Circumstances</h2>
        ...
        <section>
          <h2 className="text-brand-text text-xl font-semibold mb-4">Credit Transfers</h2>
        ...
        <section>
          <h2 className="text-brand-text text-xl font-semibold mb-4">Disputes</h2>
        ...
        <section>
          <h2 className="text-brand-text text-xl font-semibold mb-4">Changes to This Policy</h2>
        ...
        <section>
          <h2 className="text-brand-text text-xl font-semibold mb-4">Contact Us</h2>
          <p>Questions about our return policy or need to request a refund? Contact us:</p>
          <div className="mt-4 card p-4 inline-block">
            <p><strong className="text-brand-text">Vibes Consulting</strong></p>
            <p>Santa Cruz, CA</p>
