    ...
    <div className="pb-20">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16">
        <div className="card p-8">
          ...
          <p className="text-brand-text/70 mb-4">AI is everywhere, but most small businesses don't know where to start. You've heard the hype. You've tried ChatGPT. But you haven't figured out how to <strong>systematically integrate AI</strong> into your operations.</p>
          <p className="text-brand-text/70">The risk? Wasting time on tools that don't fit, exposing client data, or your team resisting adoption because they're scared or skeptical.</p>
        </div>

        <div className="card p-8">
          <h3 className="mb-4 text-current-500">What Makes This Different</h3>
          <p className="text-brand-text/70 mb-4">We're not AI evangelists. We're <strong>pragmatists</strong>. We only recommend tools that have proven ROI, prioritize data safety, and actually get used.</p>
          <p className="text-brand-text/70">You won't leave with a 50-page AI strategy doc. You'll leave with 3-5 automations running, SOPs written, and your team trained.</p>
        </div>
      </div>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-6">
          <Link href="/services/ai-integration/whats-included/opportunity-scan" className="card p-6 block group hover:border-current-600/60 transition-all">
            ...
            <p className="text-brand-text/70 mb-3">We identify the highest-value, lowest-risk AI use cases in your business.</p>
          ...
          <Link href="/services/ai-integration/whats-included/integration-plan" className="card p-6 block group hover:border-current-600/60 transition-all">
            ...
            <p className="text-brand-text/70 mb-3">We set up your AI tools, test them, and make sure they're secure.</p>
            <ul className="list-disc pl-6 text-brand-text/70 space-y-2 text-sm">
          ...
          <Link href="/services/ai-integration/whats-included/sop-library" className="card p-6 block group hover:border-current-600/60 transition-all">
            ...
            <p className="text-brand-text/70 mb-3">Your team learns how to use AI confidently and consistently.</p>
            <ul className="list-disc pl-6 text-brand-text/70 space-y-2 text-sm">
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Link href="/services/ai-integration/who-this-is-for/ai-curious" className="card p-6 block group hover:border-current-600/60 transition-all">
            ...
            <p className="text-brand-text/70 text-sm">You know AI could help, but you don't have time to experiment. You want someone to do the research and show you what works.</p>
          </Link>
          ...
          <Link href="/services/ai-integration/who-this-is-for/overwhelmed-by-repetition" className="card p-6 block group hover:border-current-600/60 transition-all">
            ...
            <p className="text-brand-text/70 text-sm">You're drowning in repetitive tasks (emails, reports, scheduling). AI can automate 30-40% of that.</p>
          </Link>
          ...
          <Link href="/services/ai-integration/who-this-is-for/non-technical-teams" className="card p-6 block group hover:border-current-600/60 transition-all">
            ...
            <p className="text-brand-text/70 text-sm">You handle sensitive client data and need to adopt AI without exposing information or violating privacy policies.</p>
          </Link>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-4">
          <div className="card p-6 border-l-4 border-current-600">
            <p className="text-brand-text/90 mb-2"><strong>Marketing agency, 6 people:</strong></p>
            <p className="text-brand-text/70">"We were spending 8 hours a week on client reporting. Vibes built an automation that pulls data from our CRM and generates reports in 15 minutes. That's 30+ hours a month back."</p>
          </div>

          <div className="card p-6 border-l-4 border-current-600">
            <p className="text-brand-text/90 mb-2"><strong>Consulting firm, 10 people:</strong></p>
            <p className="text-brand-text/70">"Our team was skeptical of AI. After the workshop, everyone had at least one use case they loved. Now AI is part of our normal workflow, not a side experiment."</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-16 card p-8 bg-current-600/10">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <p className="text-3xl font-semibold text-brand-text mb-2">$4,500</p>
            <p className="text-brand-text/70">Includes opportunity scan, implementation, training, and 4 weeks of support.</p>
            <p className="text-brand-text/60 text-sm mt-2">Typical timeline: 6-8 weeks from kickoff to full adoption</p>
            <p className="text-brand-text/60 text-sm mt-1">Can be combined with Business Flow Consulting for integrated optimization</p>
          </div>
      ...
      <section className="card p-8">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-brand-text/70">We only recommend tools with strong privacy policies, and we configure them correctly. For sensitive data, we use enterprise plans with data residency guarantees or private instances.</p>
          </div>

          <div>
            <h3 className="text-lg mb-2">What if our team is resistant to AI?</h3>
            <p className="text-brand-text/70">Normal. We address concerns directly in training and show them how AI makes their jobs easier, not replaces them. Most teams become advocates after seeing one workflow that saves them hours.</p>
          </div>

          <div>
            <h3 className="text-lg mb-2">Do we need technical skills to use these tools?</h3>
            <p className="text-brand-text/70">No. We set up everything and write SOPs so non-technical people can use them. If you can use Google Docs, you can use these tools.</p>
          </div>

          <div>
            <h3 className="text-lg mb-2">What's the typical ROI?</h3>
            <p className="text-brand-text/70">Most clients save 10-20 hours per week across their team within 2 months. At $50/hour, that's $2,000-4,000/month in reclaimed capacity.</p>
          </div>

          <div>
            <h3 className="text-lg mb-2">Can we start with just one use case?</h3>
            <p className="text-brand-text/70">Yes. We can scope a smaller engagement focused on one high-impact automation (e.g., meeting notes or client reporting). Contact us for custom pricing.</p>
          </div>
        </div>
      </section>
      ...
      <section className="mt-16 text-center">
        ...
        <p className="text-brand-text/70 max-w-2xl mx-auto mb-8">Book a 30-minute intro call to discuss your biggest time sinks and explore whether AI can help. We'll be honest about what AI can and can't do for your specific situation.</p>
