...
export default function Weeks12Page() {
  return (
    <div className="pb-20 max-w-4xl">
      ...
      <p className="text-xl text-white/90 mb-8">We identify where AI can save you time without exposing sensitive data.</p>
      ...
      <div className="space-y-8">
        <section>
          ...
          <div className="space-y-4">
            <div className="card p-6">
              ...
              <p className="text-white/70 text-sm mb-3">We meet with your team to understand your business, current pain points, and AI comfort level.</p>
            ...
            <div className="card p-6">
              ...
              <p className="text-white/70 text-sm mb-3">We interview 5-7 team members and observe daily workflows to catalog repetitive tasks.</p>
              <p className="text-white/60 text-xs">We're looking for patterns: What gets done daily? What follows a template? What involves copy-paste?</p>
            </div>

            <div className="card p-6">
              <h3 className="text-lg mb-2">Days 6-8: Time-Waste Calculation</h3>
              <p className="text-white/70 text-sm mb-3">For each task, we estimate frequency and duration. This reveals highest-impact automation opportunities.</p>
              <p className="text-white/60 text-xs">Example: "Team spends 8 hours/week writing similar client emails" = prime AI target.</p>
            </div>

            <div className="card p-6">
              <h3 className="text-lg mb-2">Days 9-10: Data Safety Audit</h3>
              <p className="text-white/70 text-sm mb-3">We categorize tasks by data sensitivity. What's safe for AI? What requires anonymization? What should stay manual?</p>
              <p className="text-white/60 text-xs">Safety first. We never recommend AI for high-risk data exposure.</p>
            </div>
          </div>
        </section>
          ...
          <div className="card p-6 bg-white/5">
            <div className="space-y-3 text-sm">
              <div className="flex justify-between">
                <span className="text-white/80">Kickoff workshop</span>
                <span className="text-current-500 font-medium">2 hours</span>
              </div>
              <div className="flex justify-between">
                <span className="text-white/80">Team interviews (per person)</span>
                <span className="text-current-500 font-medium">30 minutes</span>
              </div>
              <div className="flex justify-between">
                <span className="text-white/80">Workflow observation</span>
                <span className="text-current-500 font-medium">Passive (we shadow)</span>
              </div>
              <div className="flex justify-between">
                <span className="text-white/80">Documentation sharing</span>
        ...
        <section>
          ...
          <div className="card p-6 bg-current-600/10">
            ...
            <p className="text-white/60 text-xs mt-4">Presented in 60-minute meeting with Q&A.</p>
          </div>
        </section>

        <section className="card p-6 bg-white/5">
          <h2 className="mb-4">What Happens Next</h2>
          <p className="text-white/80">Weeks 3-4: We implement the top 3-5 AI tools with your team, create SOPs, and provide training.</p>
        </section>
      </div>
    </div>
  )
