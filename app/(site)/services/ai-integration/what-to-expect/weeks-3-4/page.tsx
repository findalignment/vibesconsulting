...
export default function Weeks34Page() {
  return (
    <div className="pb-20 max-w-4xl">
      ...
      <p className="text-xl text-brand-text/90 mb-8">We set up AI tools, create SOPs, and train your team on safe, effective use.</p>
      ...
      <div className="space-y-8">
        <section>
          ...
          <div className="space-y-4">
            <div className="card p-6">
              ...
              <p className="text-brand-text/70 text-sm mb-3">We set up the 3-5 highest-impact AI tools identified in the Discovery phase.</p>
            ...
            <div className="card p-6">
              ...
              <p className="text-brand-text/70 text-sm mb-3">We document exactly how to use each tool safely and effectively.</p>
              <ul className="text-brand-text/60 text-xs space-y-1 pl-3 mt-2">
            ...
            <div className="card p-6">
              ...
              <p className="text-brand-text/70 text-sm mb-3">Hands-on training where your team learns to use each tool.</p>
              <ul className="text-brand-text/60 text-xs space-y-1 pl-3 mt-2">
            ...
            <div className="card p-6">
              ...
              <p className="text-brand-text/70 text-sm mb-3">We meet 1-on-1 with key roles to customize AI use for their specific tasks.</p>
              <p className="text-brand-text/60 text-xs">Example: Designers need different AI skills than admin staff. We tailor training to each role.</p>
            </div>
          </div>
        </section>
          ...
          <div className="card p-6 bg-white/5">
            <div className="space-y-3 text-sm">
              <div className="flex justify-between">
                <span className="text-brand-text/70">Team training workshop</span>
                <span className="text-current-500 font-medium">2-3 hours</span>
              </div>
              <div className="flex justify-between">
                <span className="text-brand-text/70">Individual role training (optional)</span>
                <span className="text-current-500 font-medium">30 min per person</span>
              </div>
              <div className="flex justify-between">
                <span className="text-brand-text/70">Practice time (self-directed)</span>
                <span className="text-current-500 font-medium">1-2 hours/week</span>
              </div>
            </div>
            <p className="text-brand-text/60 text-xs mt-4">Most team members are productive with AI tools within first week.</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="card p-6 bg-white/5">
            <p className="text-brand-text/70 mb-3">We don't just show you tools - we teach principles.</p>
        ...
        <section>
          ...
          <div className="card p-6 bg-current-600/10">
            ...
            <p className="text-brand-text/60 text-xs mt-4">Your team is ready to use AI independently with support available.</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="card p-4">
              <h3 className="text-brand-text text-sm font-medium mb-2">Phase 1: Quick Wins</h3>
            ...
            <div className="card p-4">
              <h3 className="text-brand-text text-sm font-medium mb-2">Phase 2: Process Automation</h3>
              <ul className="text-brand-text/70 text-xs space-y-1 pl-3">
          ...
          <p className="text-brand-text/70 text-sm mt-4">Exact tools depend on your AI Opportunity Report findings.</p>
        </section>

        <section className="card p-6 bg-white/5">
          <h2 className="mb-4">What Happens Next</h2>
          <p className="text-brand-text/70">Weeks 5-6: Optimization & support. We monitor adoption, troubleshoot issues, and measure ROI.</p>
        </section>
      </div>
    </div>
  )
