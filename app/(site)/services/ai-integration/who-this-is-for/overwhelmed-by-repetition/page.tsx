...
export default function OverwhelmedPage() {
  return (
    <div className="pb-20 max-w-4xl">
      ...
      <p className="text-xl text-brand-text/90 mb-8">You're spending hours on work that doesn't require deep expertise: email drafts, meeting notes, data entry, research synthesis. AI can handle most of this - and you can supervise it.</p>
      ...
      <div className="space-y-8">
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="card p-4">
              <h3 className="text-brand-text text-sm font-medium mb-2">📧 Email & Communication</h3>
            ...
            <div className="card p-4">
              <h3 className="text-brand-text text-sm font-medium mb-2">📄 Documentation & Reports</h3>
              <ul className="text-brand-text/70 text-xs space-y-1">
            ...
            <div className="card p-4">
              <h3 className="text-brand-text text-sm font-medium mb-2">🔍 Research & Analysis</h3>
              <ul className="text-brand-text/70 text-xs space-y-1">
            ...
            <div className="card p-4">
              <h3 className="text-brand-text text-sm font-medium mb-2">✍️ Content Creation</h3>
              <ul className="text-brand-text/70 text-xs space-y-1">
            ...
            <div className="card p-4">
              <h3 className="text-brand-text text-sm font-medium mb-2">📊 Data Entry & Formatting</h3>
              <ul className="text-brand-text/70 text-xs space-y-1">
            ...
            <div className="card p-4">
              <h3 className="text-brand-text text-sm font-medium mb-2">🎓 Training & Onboarding</h3>
              <ul className="text-brand-text/70 text-xs space-y-1">
                <li>• Creating FAQs</li>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div className="card p-4">
              <p className="text-brand-text/70 text-sm">✓ You spend 10+ hours per week on tasks that feel mechanical or repetitive</p>
            </div>
            <div className="card p-4">
              <p className="text-brand-text/70 text-sm">✓ You're constantly behind on emails, documentation, or admin work</p>
            </div>
            <div className="card p-4">
              <p className="text-brand-text/70 text-sm">✓ You hire contractors or VAs for work that AI could do faster and cheaper</p>
            </div>
            <div className="card p-4">
              <p className="text-brand-text/70 text-sm">✓ You avoid tasks you know you should do because they're tedious</p>
            </div>
            <div className="card p-4">
              <p className="text-brand-text/70 text-sm">✓ Your team complains about busywork taking time away from real work</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="card p-6">
              ...
              <p className="text-brand-text/70 text-sm">We audit where your time goes and rank tasks by automation potential. Not everything should be automated - we focus on the right wins.</p>
            </div>
            <div className="card p-6">
              <h3 className="text-lg mb-2">2. Build Custom AI Workflows</h3>
              <p className="text-brand-text/70 text-sm">We design prompts, templates, and workflows for your specific use cases. You get copy-paste-ready tools, not generic advice.</p>
            </div>
            <div className="card p-6">
              <h3 className="text-lg mb-2">3. Train Your Team</h3>
              <p className="text-brand-text/70 text-sm">We run hands-on workshops so your team knows how to use AI confidently and safely. They'll understand when to trust it and when to double-check.</p>
            </div>
            <div className="card p-6">
              <h3 className="text-lg mb-2">4. Build Safety Protocols</h3>
              <p className="text-brand-text/70 text-sm">We teach you how to use AI without exposing sensitive data, introducing bias, or creating liability.</p>
            </div>
          </div>
        </section>
        ...
        <section className="card p-6 bg-white/5">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-brand-text/70 text-xs">Reclaimed per week</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-semibold text-current-500 mb-1">60-90 days</p>
              <p className="text-brand-text/70 text-xs">To full adoption</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-semibold text-current-500 mb-1">5-10x</p>
              <p className="text-brand-text/70 text-xs">Return on investment</p>
            </div>
          </div>
        </section>
        ...
        <section className="card p-6 bg-current-600/10">
          ...
          <p className="text-brand-text/70 mb-4">AI Integration is part of our Flow Rebuild package ($8,000). We identify your highest-value use cases, set up tools, and train your team - all with safety and privacy protocols built in.</p>
