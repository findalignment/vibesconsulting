    ...
    <div className="pb-20">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16">
        <div className="card p-8">
          ...
          <p className="text-brand-text/70 mb-4">You're working harder than you should be. Tasks take too long. Information gets lost. Decisions stall. Your team is capable, but the <strong>systems aren't supporting them</strong>.</p>
          <p className="text-brand-text/70">Most businesses live with invisible friction for years - until someone maps it, names it, and redesigns the flow.</p>
        </div>

        <div className="card p-8">
          <h3 className="mb-4 text-current-500">What Makes This Different</h3>
          <p className="text-brand-text/70 mb-4">We don't just recommend changes. We <strong>walk the floor with you</strong>, watch how work actually moves, and co-design solutions your team will actually use.</p>
          <p className="text-brand-text/70">No generic playbooks. No consulting theater. Just honest diagnosis and practical redesign.</p>
        </div>
      </div>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-6">
          <Link href="/services/business-flow/whats-included/friction-audit" className="card p-6 block group hover:border-current-600/60 transition-all">
            ...
            <p className="text-brand-text/70 mb-3">Two-week deep dive into where your business gets stuck.</p>
          ...
          <Link href="/services/business-flow/whats-included/flow-map" className="card p-6 block group hover:border-current-600/60 transition-all">
            ...
            <p className="text-brand-text/70 mb-3">Side-by-side comparison of how things work now vs. how they should work.</p>
            <ul className="list-disc pl-6 text-brand-text/70 space-y-2 text-sm">
          ...
          <Link href="/services/business-flow/whats-included/improvement-plan" className="card p-6 block group hover:border-current-600/60 transition-all">
            ...
            <p className="text-brand-text/70 mb-3">Phased roadmap to implement changes without disrupting operations.</p>
            <ul className="list-disc pl-6 text-brand-text/70 space-y-2 text-sm">
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Link href="/services/business-flow/who-this-is-for/growing-teams" className="card p-6 block group hover:border-current-600/60 transition-all">
            ...
            <p className="text-brand-text/70 text-sm">You've outgrown informal systems. Things that used to "just work" now require coordination and clarity.</p>
          </Link>
          ...
          <Link href="/services/business-flow/who-this-is-for/service-businesses" className="card p-6 block group hover:border-current-600/60 transition-all">
            ...
            <p className="text-brand-text/70 text-sm">Agencies, studios, consultancies where client work flows through multiple hands and handoffs cause delays.</p>
          </Link>
          ...
          <Link href="/services/business-flow/who-this-is-for/owner-operators" className="card p-6 block group hover:border-current-600/60 transition-all">
            ...
            <p className="text-brand-text/70 text-sm">You're the bottleneck. Every decision runs through you because systems don't exist yet.</p>
          </Link>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-4">
          <div className="card p-6 border-l-4 border-current-600">
            <p className="text-brand-text/90 mb-2"><strong>Creative agency, 12 people:</strong></p>
            <p className="text-brand-text/70">"Onboarding used to take 6 weeks and involve 14 different documents. Now it's 2 weeks with one intake form and a kickoff call. Clients tell us we're easier to work with than our competitors."</p>
          </div>

          <div className="card p-6 border-l-4 border-current-600">
            <p className="text-brand-text/90 mb-2"><strong>Design studio, 8 people:</strong></p>
            <p className="text-brand-text/70">"We were having 12 internal meetings a week. Vibes helped us redesign our cadence and clarify decision rights. Now we meet 4 times a week and finish projects 30% faster."</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-16 card p-8 bg-current-600/10">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <p className="text-3xl font-semibold text-brand-text mb-2">$2,500</p>
            <p className="text-brand-text/70">One-time engagement. Full credit applied if you continue with Flow Rebuild.</p>
            <p className="text-brand-text/60 text-sm mt-2">Typical timeline: 4 weeks from kickoff to final delivery</p>
          </div>
      ...
      <section className="card p-8">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-brand-text/70">No. We work around your schedule. Most observation happens during normal business hours, and interviews are 30 minutes each.</p>
          </div>

          <div>
            <h3 className="text-lg mb-2">What if we're too small for this?</h3>
            <p className="text-brand-text/70">If you have 3+ people and recurring friction, you're the right size. Most of our clients are 5-15 person teams.</p>
          </div>

          <div>
            <h3 className="text-lg mb-2">What happens after the 90-day plan is delivered?</h3>
            <p className="text-brand-text/70">You can implement it yourself, or continue with our Flow Rebuild service where we execute the plan with you. The $2,500 is credited toward that engagement.</p>
          </div>

          <div>
            <h3 className="text-lg mb-2">Do you work remotely or in-person?</h3>
            <p className="text-brand-text/70">Both. In-person is ideal for Santa Cruz and Bay Area clients. For remote teams, we do video observation and async process documentation.</p>
          </div>
        </div>
      </section>
      ...
      <section className="mt-16 text-center">
        ...
        <p className="text-brand-text/70 max-w-2xl mx-auto mb-8">Book a 30-minute intro call to see if this is the right fit. We'll ask about your biggest friction points and walk you through what a typical engagement looks like.</p>
