    ...
    <div className="pb-20 max-w-4xl">
      ...
      <div className="space-y-8">
        <section>
          ...
          <div className="space-y-4">
            <div className="card p-6">
              ...
              <p className="text-white/70 text-sm mb-3">We meet with leadership to understand your business model, current pain points, and what success looks like. We identify who to interview and which processes to observe.</p>
            ...
            <div className="card p-6">
              ...
              <p className="text-white/70 text-sm mb-3">We talk to 5-7 team members across different roles and seniority levels. These are conversational, not interrogations. We ask about daily friction, what slows them down, and what workarounds exist.</p>
              <div className="text-xs text-white/60">
            ...
            <div className="card p-6">
              ...
              <p className="text-white/70 text-sm mb-3">We shadow your team during normal operations. We watch how work moves, where handoffs happen, where delays occur. This reveals friction that people have stopped noticing.</p>
              <div className="text-xs text-white/60">
            ...
            <div className="card p-6">
              ...
              <p className="text-white/70 text-sm mb-3">We review whatever documentation you have: process docs, org charts, templates, SOPs. We assess what exists, what's missing, and what's outdated.</p>
              <div className="text-xs text-white/60">
        ...
        <section>
          ...
          <div className="card p-6 bg-white/5">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <h4 className="text-white text-sm font-medium mb-2">Team Members</h4>
                <ul className="text-white/70 text-xs space-y-1">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="card p-4">
              ...
              <p className="text-white/70 text-xs">Observation happens during normal work. We're flies on the wall, not disruptive consultants asking constant questions.</p>
            </div>
            <div className="card p-4">
              <h3 className="text-white text-sm font-medium mb-2">Async When Possible</h3>
              <p className="text-white/70 text-xs">Documentation review, analysis, and synthesis happen on our time, not yours.</p>
            </div>
            <div className="card p-4">
              <h3 className="text-white text-sm font-medium mb-2">Remote Options</h3>
              <p className="text-white/70 text-xs">For remote teams, we do video interviews and observe via screen share or recorded meetings.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="card p-6">
            <p className="text-white/80 mb-4">Discovery feeds directly into your Friction Audit Report and Flow Map. By the end of Week 2, we have everything we need to create your 90-Day Improvement Plan.</p>
            <p className="text-white/70 text-sm">You'll see a preview of key findings in Week 2 before the final presentation.</p>
          </div>
        </section>

        <section className="card p-6 bg-current-600/10">
          <h2 className="mb-4">Part of Flow Check Process</h2>
          <p className="text-white/80">Discovery happens during Week 1-2 of The Flow Check engagement.</p>
