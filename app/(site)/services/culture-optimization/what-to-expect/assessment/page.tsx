...
export default function AssessmentPage() {
  return (
    <div className="pb-20 max-w-4xl">
      ...
      <p className="text-xl text-white/90 mb-8">We diagnose culture health through surveys, interviews, and observation. This phase identifies strengths, drag points, and root causes.</p>
      ...
      <div className="space-y-8">
        <section>
          ...
          <div className="space-y-4">
            <div className="card p-6">
              ...
              <p className="text-white/70 text-sm mb-3">Meet with leadership to understand your culture challenges, history, and goals. We identify who to interview and what to observe.</p>
            ...
            <div className="card p-6">
              ...
              <p className="text-white/70 text-sm mb-3">Anonymous 5-minute survey sent to all team members. Measures morale, engagement, trust, communication, and belonging.</p>
              <div className="text-xs text-white/60">
            ...
            <div className="card p-6">
              ...
              <p className="text-white/70 text-sm mb-3">We talk to 5-8 team members across roles and seniority. Conversational, not interrogational. We ask what's working, what's not, and what would improve work life.</p>
              <div className="text-xs text-white/60">
            ...
            <div className="card p-6">
              ...
              <p className="text-white/70 text-sm mb-3">We observe meetings, workspace dynamics, and team interactions. Non-invasive "fly on the wall" approach. We watch how people communicate, collaborate, and handle conflict.</p>
              <div className="text-xs text-white/60">
            ...
            <div className="card p-6">
              ...
              <p className="text-white/70 text-sm mb-3">We assess physical and digital workspace. Does the environment support focus, collaboration, and well-being?</p>
              <div className="text-xs text-white/60">
            ...
            <div className="card p-6">
              ...
              <p className="text-white/70 text-sm mb-3">We analyze survey results, interview themes, and observation notes. We identify patterns and root causes.</p>
              <div className="text-xs text-white/60">
        ...
        <section>
          ...
          <div className="card p-6">
            <p className="text-white/80 mb-4">By Day 10, the Culture Flow Report is complete:</p>
            ...
            <p className="text-white/60 text-xs mt-4">We present this in Week 2 during the Leadership Coaching Session.</p>
          </div>
        </section>

        <section className="card p-6 bg-current-600/10">
          <h2 className="mb-4">Part of Culture Optimization Process</h2>
          <p className="text-white/80">Assessment happens during Week 1-2 of the Culture & Environment Optimization engagement.</p>
