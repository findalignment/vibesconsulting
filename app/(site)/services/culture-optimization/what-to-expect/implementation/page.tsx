...
export default function ImplementationPage() {
  return (
    <div className="pb-20 max-w-4xl">
      ...
      <p className="text-xl text-brand-text/90 mb-8">We help you roll out new rituals, systems, and space improvements. We train your team, manage change communication, and ensure adoption.</p>
      ...
      <div className="space-y-8">
        <section>
          ...
          <div className="space-y-4">
            <div className="card p-6">
              ...
              <p className="text-brand-text/70 text-sm mb-3">Leadership introduces culture improvements to the full team. We help you communicate why changes are happening and what to expect.</p>
            ...
            <div className="card p-6">
              ...
              <p className="text-brand-text/70 text-sm mb-3">We introduce new rituals (recognition, meetings, feedback loops) and train team on how to participate.</p>
              <div className="text-xs text-brand-text/60">
            ...
            <div className="card p-6">
              ...
              <p className="text-brand-text/70 text-sm mb-3">Physical and digital workspace changes begin. We provide vendor recommendations, manage logistics, and ensure adoption.</p>
              <div className="text-xs text-brand-text/60">
            ...
            <div className="card p-6">
              ...
              <p className="text-brand-text/70 text-sm mb-3">Weekly 30-minute calls with leadership. Troubleshoot issues, adjust approach, and ensure momentum.</p>
              <div className="text-xs text-brand-text/60">
            ...
            <div className="card p-6">
              ...
              <p className="text-brand-text/70 text-sm mb-3">Quick anonymous survey sent to team. Measure early reactions to changes and identify concerns.</p>
              <p className="text-brand-text/60 text-xs">This helps us adjust before issues compound.</p>
            </div>

            <div className="card p-6">
              <h3 className="text-lg mb-2">Final Handoff & Training (Days 35-40)</h3>
              <p className="text-brand-text/70 text-sm mb-3">We train leadership on how to sustain changes: how to run Vibe Resets, how to coach team on new rituals, and how to measure progress.</p>
              <div className="text-xs text-brand-text/60">
        ...
        <section>
          ...
          <div className="card p-6 bg-white/5">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <h4 className="text-brand-text text-sm font-medium mb-2">Team</h4>
                <ul className="text-brand-text/70 text-xs space-y-1">
        ...
        <section>
          ...
          <div className="space-y-3">
            <div className="card p-4 bg-current-600/10">
              <p className="text-brand-text/70 text-sm">✓ New rituals are running without external facilitation</p>
            </div>
            <div className="card p-4 bg-current-600/10">
              <p className="text-brand-text/70 text-sm">✓ Team is participating voluntarily (not feeling forced)</p>
            </div>
            <div className="card p-4 bg-current-600/10">
              <p className="text-brand-text/70 text-sm">✓ Leadership can run Vibe Resets independently</p>
            </div>
            <div className="card p-4 bg-current-600/10">
              <p className="text-brand-text/70 text-sm">✓ Early morale indicators are positive (pulse check results)</p>
            </div>
            <div className="card p-4 bg-current-600/10">
              <p className="text-brand-text/70 text-sm">✓ Space improvements are complete and being used</p>
            </div>
          </div>
        </section>
        ...
        <section className="card p-6 bg-current-600/10">
          ...
          <p className="text-brand-text/70">Implementation happens during Week 5-6 of the Culture & Environment Optimization engagement.</p>
